  ...
  return (
    <PageShell title="My Wallet" subtitle="Manage your funds and transactions" icon={WalletIcon} maxWidth="6xl">
      ...
      {offerSettings.bonusEnabled && (
        <Card className="mb-6 sm:mb-8 p-5 sm:p-6 bg-blue-600 text-white overflow-hidden relative border-0 shadow-[0_8px_32px_-8px_hsl(220_70%_40%/0.5)] animate-fade-in">
