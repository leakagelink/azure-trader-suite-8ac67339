          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
              ...
              <div className="flex flex-col items-center md:items-start gap-3 sm:col-span-2 md:col-span-1">
                <div className="flex items-center gap-2 sm:gap-3">
                  <img src={logo} alt="CoinGoldFX" className="h-14 w-14 sm:h-16 sm:w-16 object-contain" />
                </div>
              ...
              <div className="flex flex-col items-center md:items-start gap-3">
                ...
                <div className="text-xs sm:text-sm text-muted-foreground text-center md:text-left space-y-2">
                  ...
                  <p>
                    <a href="mailto:support@coingoldfx.com" className="hover:text-primary transition-colors inline-flex items-center gap-2">
                      <CheckCircle className="h-3.5 w-3.5 text-accent" />
                      support@coingoldfx.com
                    </a>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
              <p className="text-xs sm:text-sm text-muted-foreground">
                © 2024 <span className="font-bold text-foreground">CoinGoldFX</span>. All rights reserved.
              </p>
